...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerLightningBoltEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (inspectorTarget.WeatherScript != null)
            {
                //2D settings toggle on and off depending if the target camera is orthographic
                if ((inspectorTarget.WeatherScript.Camera != null && inspectorTarget.WeatherScript.Camera.orthographic) ||
                    (inspectorTarget.WeatherScript.Camera == null && Camera.main != null && Camera.main.orthographic))
                {
