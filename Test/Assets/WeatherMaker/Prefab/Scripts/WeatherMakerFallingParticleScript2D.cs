...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerFallingParticleScript2D : WeatherMakerFallingParticleScript
    {
        ...
        private void TransformParticleSystem(ParticleSystem p, float initialStartSpeed, float initialStartSize)
        {
            ...
            p.transform.position = new Vector3(WeatherScript.Camera.transform.position.x, visibleBounds.max.y + yOffset, p.transform.position.z);
        ...
        protected override void Update()
        {
            ...
            cameraMultiplier = (WeatherScript.Camera.orthographicSize * 0.25f);
            visibleBounds.min = WeatherScript.Camera.ViewportToWorldPoint(Vector3.zero);
            visibleBounds.max = WeatherScript.Camera.ViewportToWorldPoint(Vector3.one);
