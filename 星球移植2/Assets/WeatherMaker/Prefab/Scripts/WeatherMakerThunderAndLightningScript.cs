...
namespace DigitalRuby.WeatherMaker
{
    public abstract class WeatherMakerThunderAndLightningScript : MonoBehaviour
    {
        ...
        [Tooltip("Whether lightning is enabled or not")]
        ...
        private IEnumerator ProcessLightning(Vector3? start, Vector3? end, bool? _intense = null, bool? _forceVisible = null)
        {
            ...
            // perform the strike
            Strike(start, end, intense, intensity, WeatherScript.Camera, forceVisible);
        ...
        protected virtual void Update()
        {
            ...
            {
                NextLightningTime = Time.time + LightningIntervalTimeRange.Minimum;
            }
        }
